...
class Rectangle:
    ...
    def from_diagonal(cls, diagonal, aspect_ratio):
        # Пусть width = x, тогда height = x / aspect_ratio
        # По теореме Пифагора: x^2 + (x / aspect_ratio)^2 = diagonal^2
        width = sqrt(diagonal**2 / (1 + (1 / aspect_ratio) ** 2))
...
print(rectangle2.area())  # 10.0128   # IMPORTANT ответ в примере не соотвтетствует расчетам
